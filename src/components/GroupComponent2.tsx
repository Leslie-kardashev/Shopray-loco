...
const GroupComponent2: FunctionComponent<GroupComponent2Type> = ({
  ...
  }, [groupDivFlex, groupDivAlignSelf]);

  return (
    <div
      className={`flex-[0.9402] rounded-lg bg-gray-300 border-dimgray border-[1px] border-dashed box-border flex flex-col items-start justify-start pt-2.5 pb-[11px] pl-2.5 pr-[9px] gap-[5px] max-w-full text-left text-sm text-white font-instrument-sans mq900:flex-1 ${className}`}
      style={groupDivStyle}
    >
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-1.5 text-5xs">
      ...
      <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-2.5 box-border gap-3.5 max-w-full">
      ...
      <div className="self-stretch rounded-6xs border-springgreen border-[1px] border-solid box-border flex flex-row items-end justify-start py-1.5 px-[95px] max-w-full z-[1] text-springgreen mq900:pl-5 mq900:pr-5 mq900:box-border">
        ...
        <img
          ...
          src={add}
        />
        <h2 className="m-0 w-[119px] relative text-inherit tracking-[-0.05em] font-bold font-[inherit] flex items-center shrink-0 z-[2]">
          Connect to Shop
        </h2>
      </div>
    </div>
