...
const FrameComponent3: FunctionComponent<FrameComponent3Type> = ({
  ...
  return (
    <div
      className={`flex-1 flex flex-col items-start justify-start py-0 pl-0 pr-1 box-border max-w-full text-left text-5xs text-white font-instrument-sans ${className}`}
    >
      <div className="self-stretch rounded-lg bg-gray-300 border-dimgray border-[1px] border-dashed box-border flex flex-col items-start justify-start pt-2.5 pb-[11px] pl-2.5 pr-[9px] gap-[5px] max-w-full z-[1]">
